<?php
/* Smarty version 4.5.3, created on 2025-04-03 14:57:44
  from 'C:\Apache24\htdocs\crm\public\legacy\cache\themes\suite8\modules\Users\DetailView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_67eea1e8bd65a9_84326015',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ec5cc851a9f8730c5d58d22e56f49af09a9796e8' => 
    array (
      0 => 'C:\\Apache24\\htdocs\\crm\\public\\legacy\\cache\\themes\\suite8\\modules\\Users\\DetailView.tpl',
      1 => 1743692264,
      2 => 'file',
    ),
  ),
...
'"/>
<?php }?>
<input id="duplicate_button" title="Дублировать" accessKey="u" class="button" onclick="var _form = document.getElementById('formDetailView');_form.return_module.value='Users'; _form.return_action.value='DetailView'; _form.isDuplicate.value=true; _form.action.value='EditView';window.location.href='index.php?' + (new URLSearchParams(new FormData(_form)).toString());" type="button" name="Duplicate" value="Дублировать"/>
<input name="delete" id="delete_button" title="Удалить" type="button" class="button" onclick="confirmDelete();" value="Удалить"/>
<br />
<b>Deprecated</b>:  strlen(): Passing null to parameter #1 ($string) of type string is deprecated in <b>C:\Apache24\htdocs\crm\public\legacy\include\SugarHtml\SugarHtml.php</b> on line <b>307</b><br />
<input title="Установить стандартные значения" class="button" LANGUAGE="javascript" onclick="if(confirm('Вы действительно хотите сбросить все настройки данного пользователя?')) window.location='index.php?module=Users&action=resetPreferences&reset_preferences=true&record=<?php echo $_smarty_tpl->tpl_vars['fields']->value['id']['value'];?>
';" type="button" name="password" value="Установить стандартные значения"/>
<br />
<b>Deprecated</b>:  strlen(): Passing null to parameter #1 ($string) of type string is deprecated in <b>C:\Apache24\htdocs\crm\public\legacy\include\SugarHtml\SugarHtml.php</b> on line <b>307</b><br />
<input title="Сбросить настройки основной закладки SuiteCRM" class="button" LANGUAGE="javascript" onclick="if(confirm('Вы действительно хотите сбросить настройки основной закладки SuiteCRM?')) window.location='index.php?module=Users&action=DetailView&reset_homepage=true&record=<?php echo $_smarty_tpl->tpl_vars['fields']->value['id']['value'];?>
';" type="button" name="password" value="Сбросить настройки основной закладки SuiteCRM"/>
...
<li><input name="delete" id="delete_button" title="Удалить" type="button" class="button" onclick="confirmDelete();" value="Удалить"/></li>
<li><br />
<b>Deprecated</b>:  strlen(): Passing null to parameter #1 ($string) of type string is deprecated in <b>C:\Apache24\htdocs\crm\public\legacy\include\SugarHtml\SugarHtml.php</b> on line <b>307</b><br />
<input title="Установить стандартные значения" class="button" LANGUAGE="javascript" onclick="if(confirm('Вы действительно хотите сбросить все настройки данного пользователя?')) window.location='index.php?module=Users&action=resetPreferences&reset_preferences=true&record=<?php echo $_smarty_tpl->tpl_vars['fields']->value['id']['value'];?>
...
<b>Deprecated</b>:  strlen(): Passing null to parameter #1 ($string) of type string is deprecated in <b>C:\Apache24\htdocs\crm\public\legacy\include\SugarHtml\SugarHtml.php</b> on line <b>307</b><br />
<input title="Сбросить настройки основной закладки SuiteCRM" class="button" LANGUAGE="javascript" onclick="if(confirm('Вы действительно хотите сбросить настройки основной закладки SuiteCRM?')) window.location='index.php?module=Users&action=DetailView&reset_homepage=true&record=<?php echo $_smarty_tpl->tpl_vars['fields']->value['id']['value'];?>
';" type="button" name="password" value="Сбросить настройки основной закладки SuiteCRM"/></li>
